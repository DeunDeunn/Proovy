...
class NotificationControllerTest {
    ...
    void getNotifications_delegatesToService() throws Exception {
        ...
        mockMvc.perform(get("/api/notifications?userId=1&page=0&size=20"))
    ...
    void markAsRead_delegatesToService() throws Exception {
        ...
        mockMvc.perform(patch("/api/notifications/10/read?userId=1"))
                .andExpect(status().isOk())
    ...
    void delete_delegatesToService() throws Exception {
        ...
        mockMvc.perform(delete("/api/notifications/10?userId=1"))
                .andExpect(status().isOk())
